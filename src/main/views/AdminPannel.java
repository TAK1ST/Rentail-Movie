...
public class AdminPannel {
    ...
    private static void accountMenu() {
        Menu.showManagerMenu("Account Managment",
            null,
            new MenuOption[]{
                new MenuOption("Add Account", () -> getACM().addAccount(), ASK_FOR_AGAIN),
                ...
                new MenuOption("Display Accounts", () -> getACM().displayWithSort()),
    ...
    private static void actorMenu() {  
        Menu.showManagerMenu(
            ...
            new MenuOption[]{
                ...
                new MenuOption("Show all actor", () -> getATM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void discountMenu() {
        Menu.showManagerMenu("Discount Managment",
            ...
            new MenuOption[]{
                ...
                new MenuOption("Display Discount", () -> getDCM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void genreMenu() {  
        Menu.showManagerMenu(
            ...
            new MenuOption[]{
                ...
                new MenuOption("Show all genre", () -> getGRM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void languageMenu() {
        Menu.showManagerMenu("Language Managment",
            ...
            new MenuOption[]{
                ...
                new MenuOption("Display Languages", () -> getLGM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void movieMenu() {
        Menu.showManagerMenu(
            ...
            new MenuOption[]{
                ...
                new MenuOption("Show all movie", () -> getMVM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void paymentMenu() {
        Menu.showManagerMenu("Payment Managment",
            ...
            new MenuOption[]{
                ...
                new MenuOption("Display Payments", () -> getPMM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void profileMenu() {
        Menu.showManagerMenu("Profile Managment",
            ...
            new MenuOption[]{
                ...
                new MenuOption("Display Profiles", () -> getPFM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void rentalMenu() {
        Menu.showManagerMenu(
                ...
                new MenuOption[]{
                    ...
                    new MenuOption("Show all rental", () -> getRTM().displayWithSort()),
                    new MenuOption("Back", EXIT_MENU)
                },
                null
        );
    ...
    private static void reviewMenu() {
        Menu.showManagerMenu(
            ...
            new MenuOption[]{
                ...
                new MenuOption("Show all review", () -> getRVM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
    ...
    private static void wishlistMenu() {
        Menu.showManagerMenu("Wishlist Managment",
            ...
            new MenuOption[]{
                ...
                new MenuOption("Display Wishlists", () -> getWLM().displayWithSort()),
                new MenuOption("Back", EXIT_MENU)
            },
            null
        );
